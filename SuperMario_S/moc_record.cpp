...
QT_MOC_LITERAL(1, 7, 5), // "level"
QT_MOC_LITERAL(2, 13, 6), // "record"
QT_MOC_LITERAL(3, 20, 6) // "holder"

    },
    "Record\0level\0record\0holder"
};
...
void Record::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->level(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->record(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->holder(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setLevel(*reinterpret_cast< QString*>(_v)); break;
        case 1: _t->setRecord(*reinterpret_cast< QString*>(_v)); break;
        case 2: _t->setHolder(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
